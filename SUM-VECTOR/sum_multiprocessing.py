...
def main() -> None:
    parser = argparse.ArgumentParser(description="Suma de vector en paralelo con multiprocessing.Pool")
    ...
    print_result("multiprocessing.Pool", len(vector), args.workers, result, end)
