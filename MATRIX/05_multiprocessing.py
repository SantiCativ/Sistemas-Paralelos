"""Multiplicación de matrices — multiprocessing.Pool (mismo patrón que sum_multiprocessing.py)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Multiplicación de matrices — multiprocessing.Pool")
    ...
    print_result("multiprocessing_pool", args.workers, n, checksum(C), elapsed)
