"""Multiplicación de matrices — concurrent.futures.ThreadPoolExecutor."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Multiplicación de matrices — ThreadPoolExecutor")
    ...
    print_result("threadpoolexecutor", args.workers, n, checksum(C), elapsed)
